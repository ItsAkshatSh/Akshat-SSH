    ...
    >
      <header className="flex items-center justify-between px-4 sm:px-6 py-4 shrink-0">
        <p className="text-xs text-neutral-400 tracking-[0.25em] uppercase">
          ph.{String(selectedIndex + 1).padStart(2, '0')} / {String(PHOTOS.length).padStart(2, '0')}
        </p>
        <button
          className="interactive h-10 px-4 rounded-xl border border-white/10 text-neutral-300 hover:text-white hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300 text-sm tracking-widest uppercase"
          aria-label="Close"
          onClick={onClose}
        >
          Close
      ...
      <div className="relative flex-1 flex items-center justify-center min-h-0 px-14 sm:px-20 pb-6">
        {selectedIndex > 0 && (
          <button
            className="interactive absolute left-3 sm:left-6 top-1/2 -translate-y-1/2 h-12 px-3 rounded-xl border border-white/10 text-neutral-300 hover:text-white hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300 text-lg tracking-widest"
        ...
        {selectedIndex < PHOTOS.length - 1 && (
          <button
            className="interactive absolute right-3 sm:right-6 top-1/2 -translate-y-1/2 h-12 px-3 rounded-xl border border-white/10 text-neutral-300 hover:text-white hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300 text-lg tracking-widest"

/**
 * DomeGallery
 * 3D dome of images with drag inertia and shared-element enlarge, from
 * React Bits. Rendered in plain JSX for this project.
 *
 * The matching `.sphere-root`, `.sphere-main`, `.item*`, `.viewer*`, and
 * `.edge-fade*` styles live in `styles/globals.css` because Next.js
 * Pages Router only permits global CSS imports from `_app.jsx`.
 */
...
function buildItems(pool, seg) {
  ...
  // Try to avoid adjacent duplicates so the dome looks varied.
